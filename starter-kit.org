...
* Load my-setup file
My personal settings are defined in one org file names
[[file:starter-kit-my_setup.org][starter-kit-my_setup.org]]
The following code loads this file:
#+BEGIN_SRC emacs-lisp
(starter-kit-load "my_setup")
#+END_SRC

#+RESULTS:
: Loaded /Users/david/.emacs.d/starter-kit-my_setup.el
